...
function multipleBoxShadow(n)
{
    ...
    var i=0
    while(n > i){
      if(i+1 == n){value += randomIntFromInterval(0,2000)+"px "+randomIntFromInterval(0,2000)+"px #8B1ADA"}else{value += randomIntFromInterval(0,2000)+"px "+randomIntFromInterval(0,2000)+"px #8B1ADA, "}
      i+=1
    }
    return value
}
